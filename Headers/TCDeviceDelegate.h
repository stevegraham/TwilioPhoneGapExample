...
/** TCDevice is no longer listening for incoming connections.
 ...
 @param error An NSError indicating the reason the TCDevice went offline. If the error is nil, this means that the incoming listener was successfully disconnected (for example, -[TCDevice unlisten] was called)
